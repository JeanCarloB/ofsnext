...
function Products() {
  return (
    <div className="flex flex-col justify-center items-center gap-2">
      <h1 className="font-bold text-center text-5xl mb-5"><p className="animate-spin">☀️</p> Solar panels Inc.</h1>
